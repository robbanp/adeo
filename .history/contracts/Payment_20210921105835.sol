...
contract Payment {
    ...
    function authorize(string memory _merchantId, string memory _transactionId, uint256 _amount, address _receiver) public view returns (string memory response) {
